...
- Name: advanced-smoke.spec.ts >> Advanced smoke: skills + memory >> unauthenticated user is redirected from settings to login
- Location: tests/e2e/advanced-smoke.spec.ts:198:3
