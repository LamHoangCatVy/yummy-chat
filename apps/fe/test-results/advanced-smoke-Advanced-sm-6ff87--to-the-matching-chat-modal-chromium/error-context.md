...
- Name: advanced-smoke.spec.ts >> Advanced smoke: skills + memory >> legacy settings URLs redirect to the matching chat modal
- Location: tests/e2e/advanced-smoke.spec.ts:180:3
